...
Original file is located at
    https://colab.research.google.com/drive/1YPzWB9m0Ph_6IIVigyzOi-QfUjxNImOK
...
for n in range(2, 25):
    clf = DecisionTreeClassifier(random_state=1, max_depth=3, max_features=3)
    cv_scores = cross_val_score(clf, all_features_scaled, all_classes, cv=n)
    print (n, cv_scores.mean())

y_pred = clf.fit(training_inputs, training_classes).predict(testing_inputs)
cm = metrics.confusion_matrix(testing_classes, y_pred)
print(cm)
